                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('type_document') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="type_document" type="number" class="form-control" name="type_document" value="{{ old('type_document') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('number_document') ? ' has-error' : '' }}">
                            <label for="number_document" class="col-md-4 control-label">Number Document</label>

                            <div class="col-md-6">
                                <input id="number_document" type="text" class="form-control" name="number_document" value="{{ old('number_document') }}" required autofocus>
